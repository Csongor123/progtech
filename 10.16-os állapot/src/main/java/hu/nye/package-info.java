...
Játékos nevének bekérése: A program bekéri
az első játékos (az emberi játékos) nevét a felhasználótól.

Játékosok létrehozása:
Két játékos jön létre:
Player 1: emberi játékos, akinek a nevét a
felhasználó adja meg, és a sárga korongot használja ('S').
