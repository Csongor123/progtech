...
A lépések érvényességét ellenőrzi, és ha
egy lépés nem érvényes, újra kéri a játékostól.
Győzelem és döntetlen ellenőrzése: Minden lépés után ellenőrzi,
hogy a lépést végrehajtó játékos nyert-e
